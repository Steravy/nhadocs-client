...
const Dto = [
  {
    ...
    generalInfo:
      "Sexo Masculino | Data de nascimento 24 de Outubro de 1996 | Nacionalidade Havaian",
...
export default function TemplatePage() {
  return (
    ...
    >
      <Toolbar />
      <Divider textAlign="left" sx={{ mb: "20px" }}>
        INFORMAÇÃO PESSOAL
      </Divider>
              ...
              return (
                <>
                  ...
                  <ListItem sx={{ p: 0 }} key={"2"}>
                    ...
                    <ListItemText primary={person.location} />
                  </ListItem>
                  ...
                  <ListItem sx={{ p: 0 }} key={"4"}>
                    ...
                    <ListItemText primary={person.cellPhone} />
                  </ListItem>
                  ...
                  <ListItem sx={{ p: 0 }} key={"6"}>
                    ...
                    <ListItemText primary={person.generalInfo} />
                  </ListItem>
                </>
              );
            })}
      ...
      >
        ...
        >
          <Stack spacing={0}>
            <Typography>
              {"Cópia dos diplomas e certificados mencionados"}
            </Typography>
            <Typography>
              {"Cópia do cartão nacional de identificação"}
            </Typography>
            <Typography>
              {"Cópia do cartão nacional de identificação"}
            </Typography>
